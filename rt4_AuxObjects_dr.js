...
import {altView} from "./rt4_events_dr.js";
...
class Vector {
    ...
    transform(originPOS, endPOS) {
        ...
        //this.direction = [this.x, this.y, this.z];
    }
}
...
class IntersectData {
    ...
    lightList;
    viewPoint;
    constructor(intResults, ray, lightList) {
        this.parseResults(intResults, ray, lightList);
    }

    parseResults(intResults, ray, lightList) {
        ...
        this.intInLight = vec3.create();
        vec3.subtract(this.intInLight, lightList[0].position.loc, this.intPoint);
        vec3.normalize(this.intInLight, this.intInLight);
    ...
    getIntersection() {return this.intPoint}
}
